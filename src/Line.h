...
namespace Netlist {
  ...
  class Line {
    //Cette class repere dans le fichire XML les deux noeuds par leurs index et dans la représentation en mémoire elle le fait via des pointeurs.
    public:
    ...
    private:
      Node* source_; // Noued depuis lequel la ligne part
      Node* target_;// Noeud vers lequel la ligne arrive
  };
